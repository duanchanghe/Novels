...
export default function BooksPage() {
  ...
  const booksList = data?.items || books || [];
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center gap-4 text-xs text-gray-500 dark:text-gray-400 mb-4">
                      <span>{book.total_chapters} 章节</span>
                    ...
                    <div className="flex gap-2">
                      {book.status === 'done' ? (
                        <>
                          ...
                          <button className="btn-outline p-2" title="下载">
                        ...
                        <>
                          ...
                          <button
                            ...
                            className="btn-outline p-2 text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20"
                          >
